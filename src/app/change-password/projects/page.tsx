...
export default function ChangePasswordProjects() {
    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          <div className="mb-8">
            <Link href="/dashboard" className="inline-flex items-center text-sm font-bold text-red-600 hover:underline mb-6">
              ← Back to Dashboard
            </Link>
            <h2 className="text-3xl font-black text-gray-900 mb-2">Change Password</h2>
            <p className="text-gray-600">Update your Projects account password</p>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 text-center">
            <p className="text-sm text-gray-600">
              Need ChatMe access?{' '}
              <Link href="/change-password/chatme" className="font-bold text-purple-600 hover:underline">
                Change ChatMe password
              </Link>
            </p>
          </div>
        </div>
