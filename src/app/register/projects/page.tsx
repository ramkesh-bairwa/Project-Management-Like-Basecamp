      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: '60px', color: '#fff', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '500px' }}>
          ...
          <p style={{ fontSize: '18px', opacity: 0.9, lineHeight: 1.7, marginBottom: '40px' }}>
            Join thousands of teams delivering projects faster with ProjectHub. Create your free account and transform how you work.
          </p>

          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            {[
              { icon: '🚀', text: 'Set up your first project in minutes' },
              { icon: '💯', text: 'Free forever with unlimited tasks' },
              { icon: '🔒', text: 'Bank-level security & data protection' },
              { icon: '🌍', text: 'Collaborate from anywhere in the world' },
            ].map((feature, i) => (
      ...
      <div style={{ width: '550px', background: '#fff', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '60px', boxShadow: '-10px 0 40px rgba(0,0,0,0.1)' }}>
        <div style={{ maxWidth: '400px', margin: '0 auto', width: '100%' }}>
          <div style={{ marginBottom: '40px' }}>
            ...
            <p style={{ color: '#64748b', fontSize: '15px' }}>Start your free ProjectHub journey</p>
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ marginBottom: '24px' }}>
            ...
            >
              {loading ? 'Creating account...' : 'Create Projects Account'}
            </button>
          </form>

          <p style={{ fontSize: '12px', color: '#94a3b8', textAlign: 'center', marginBottom: '20px' }}>
            By signing up, you agree to our{' '}
            <Link href="/terms" style={{ color: '#e63946', textDecoration: 'none' }}>Terms</Link>
            {' '}and{' '}
            <Link href="/privacy" style={{ color: '#e63946', textDecoration: 'none' }}>Privacy Policy</Link>
          </p>

          <div style={{ textAlign: 'center' }}>
            <span style={{ color: '#64748b', fontSize: '14px' }}>
              Already have an account?{' '}
              <Link href="/login/projects" style={{ color: '#e63946', fontWeight: 700, textDecoration: 'none' }}>
                Sign in
              </Link>
            </span>
          </div>
          ...
          <div style={{ marginTop: '24px', paddingTop: '24px', borderTop: '1px solid #e2e8f0', textAlign: 'center' }}>
            <Link href="/register/chatme" style={{ color: '#64748b', fontSize: '13px', textDecoration: 'none', fontWeight: 600 }}>
              Need ChatMe instead? <span style={{ color: '#667eea' }}>Sign up here →</span>
            </Link>
          </div>
        </div>
      </div>
