...
export default function ForgotPasswordProjects() {
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #e63946 0%, #c1121f 100%)' }}>
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          <div className="mb-8">
            ...
            <p className="text-xl text-white/80 mb-8">Reset your password to get back to work</p>
          </div>
        ...
        <div className="w-full max-w-md">
          ...
          {sent ? (
            <div className="bg-green-50 border border-green-200 rounded-xl p-6 text-center">
              ...
              <Link href="/login/projects" className="text-sm font-bold text-red-600 hover:underline">Back to login</Link>
            </div>
          ) : loading ? (
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 text-center">
            <p className="text-sm text-gray-600">
              Need ChatMe access?{' '}
              <Link href="/forgot-password/chatme" className="font-bold text-purple-600 hover:underline">
