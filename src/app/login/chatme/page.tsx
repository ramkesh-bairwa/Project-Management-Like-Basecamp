...
export default function ChatMeLoginPage() {
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: '60px', color: '#fff', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '500px' }}>
          ...
          <p style={{ fontSize: '18px', opacity: 0.9, lineHeight: 1.7, marginBottom: '40px' }}>
            Real-time messaging, group chats, and seamless team communication. Stay connected with your team, anytime, anywhere.
          </p>

          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            {[
              { icon: '⚡', text: 'Instant messaging with real-time updates' },
              { icon: '👥', text: 'Create groups and channels' },
              { icon: '📎', text: 'Share files, images, and code snippets' },
              { icon: '🔔', text: 'Smart notifications and mentions' },
            ].map((feature, i) => (
      ...
      <div style={{ width: '550px', background: '#fff', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '60px', boxShadow: '-10px 0 40px rgba(0,0,0,0.1)' }}>
        <div style={{ maxWidth: '400px', margin: '0 auto', width: '100%' }}>
          <div style={{ marginBottom: '40px' }}>
            ...
            <p style={{ color: '#64748b', fontSize: '15px' }}>Sign in to continue to ChatMe</p>
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ marginBottom: '30px' }}>
            ...
            <div style={{ marginBottom: '24px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                ...
                <Link href="/forgot-password/chatme" style={{ fontSize: '13px', color: '#667eea', textDecoration: 'none', fontWeight: 600 }}>
                  Forgot Password?
                </Link>
              </div>
              <input
            ...
            >
              {loading ? 'Signing in...' : 'Sign In to ChatMe'}
            </button>
          </form>
          ...
          <div style={{ textAlign: 'center' }}>
            <span style={{ color: '#64748b', fontSize: '14px' }}>
              ...
              <Link href="/register/chatme" style={{ color: '#667eea', fontWeight: 700, textDecoration: 'none' }}>
                Sign up
              </Link>
            </span>
          </div>
          ...
          <div style={{ marginTop: '24px', paddingTop: '24px', borderTop: '1px solid #e2e8f0', textAlign: 'center' }}>
            <Link href="/login/projects" style={{ color: '#64748b', fontSize: '13px', textDecoration: 'none', fontWeight: 600 }}>
              Looking for Projects? <span style={{ color: '#e63946' }}>Sign in here →</span>
            </Link>
          </div>
        </div>
      </div>
