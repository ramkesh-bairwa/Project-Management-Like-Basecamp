...
export default function ResetPasswordChatMe() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        setSuccess(true);
        setTimeout(() => router.push('/login/chatme'), 3000);
      } else {
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Enter your new password for ChatMe</p>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/reset-password/projects" className="font-bold text-red-600 hover:underline">
